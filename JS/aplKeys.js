...
jQuery(function($) {
  ...
  layout = {
    "default": ['` 1 2 3 4 5 6 7 8 9 0 - =', 'q w e r t y u i o p [ ] \\', 'a s d f g h j k l ; \' {enter}', '{shift} z x c v b n m , . / {bksp}', '{alt} {space} {alt}'],
    shift: ['~ ! @ # $ % ^ & * ( ) _ +', 'Q W E R T Y U I O P { } |', 'A S D F G H J K L : " {empty}', '{shift} Z X C V B N M < > ? {bksp}', '{alt} {space} {alt}'],
    alt: ['` ¨ ¯ < ≤ = ≥ > ≠ ∨ ∧ ÷ ×',
 '{empty} ⍵ ∊ ⍴ ~ ↑ ↓ ⍳ ○ ⍟ ← → ⍀ {empty}',
 '⍺ ⌈ ⌊ {empty} ∇ ∆ ∘ {empty} ⎕ ⋄ {empty}',
 '{shift} ⊂ ⊃ ∩ ∪ ⊥ ⊤ ∣ ⍪ {empty} ⌿ {bksp}',
